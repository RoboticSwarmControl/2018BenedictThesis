...
My contribution was focused on creating the Intestine Phantom Model and Bovine Intestine model for physical implementation of the algorithm, along with obtaining experimental results. 
